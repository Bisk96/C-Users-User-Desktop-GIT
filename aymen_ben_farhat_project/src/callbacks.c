...
int c1,d1;
char a1[20],b1[20];
f=fopen("/home/aymen/Projects/project3/src/users.txt","r");
f1=fopen("/home/aymen/Projects/project3/src/tempo.txt","w");
...
f=fopen("/home/aymen/Projects/project3/src/rendezvous.txt","a+");
f2=fopen("/home/aymen/Projects/project3/src/dispo.txt","a+");
f3=fopen("/home/aymen/Projects/project3/src/tempo.txt","r");
int x;
char t[50];
...
input4= lookup_widget(button,"entry4000");
input5= lookup_widget(button,"entry5000");
input6= lookup_widget(button,"entry6000");
input7= lookup_widget(button,"entry7000");
t1=fopen("/home/aymen/Projects/project3/src/profiles.txt","r");
t2=fopen("/home/aymen/Projects/project3/src/tempo.txt","r");
...
gtk_entry_set_text(GTK_ENTRY(input4),d2);
gtk_entry_set_text(GTK_ENTRY(input5),e2);
gtk_entry_set_text(GTK_ENTRY(input6),f2);
gtk_entry_set_text(GTK_ENTRY(input7),g2);
fclose(t1);
fclose(t2);
}
...
t=fopen("/home/aymen/Projects/project3/src/tempo.txt","r");
f1=fopen("/home/aymen/Projects/project3/src/profiles.txt","a+");
ftemp=fopen("/home/aymen/Projects/project3/src/temp.txt","a+");
...
fclose(t);
fclose(ftemp);
remove ("/home/aymen/Projects/project3/src/profiles.txt");
rename ("/home/aymen/Projects/project3/src/temp.txt","/home/aymen/Projects/project3/src/profiles.txt");
...
{ gtk_label_set_text(GTK_LABEL(output103),"verifiez vos information svp!");}
...
FILE *ftemp;
FILE *t;
f1=fopen("/home/aymen/Projects/project3/src/rendezvous.txt","r");
ftemp=fopen("/home/aymen/Projects/project3/src/temp.txt","a+");
t=fopen("/home/aymen/Projects/project3/src/tempo.txt","r");
...
fclose(ftemp);
fclose(t);
remove ("/home/aymen/Projects/project3/src/rendezvous.txt");
rename ("/home/aymen/Projects/project3/src/temp.txt","/home/aymen/Projects/project3/src/rendezvous.txt");
